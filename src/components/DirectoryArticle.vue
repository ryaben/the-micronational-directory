        ...
        <div class="directory-article-container" :key="componentKey">
            <div class="article-title">
                <div class="article-full-name">
                    ...
                    <p v-if="info.name.mainAlt !== '' || info.name.titleAlt !== ''" class="article-text article-alt-name">
                        (<b>{{info.name.mainAlt}}</b><span v-if="info.name.titleAlt !== ''">,&nbsp;</span>{{info.name.titleAlt}})
                    </p>
                </div>
                <div class="article-full-name">
            ...
            <div class="article-content">
                ...
                <div class="article-column">
                    ...
                    <p class="article-text">
                        <span class="underlined">Memberships:</span><br><span
                ...
                <div class="article-column">
                    <div>
                        <p class="article-text breakable underlined">Location:</p>
                        <span v-if="!info.location._lat && !info.location._long">Not applicable or available.</span>
                        <EntrySource class="entry-source" v-if="info.location._lat && info.location._long"
                            :flag-source="info.flag" :size="46" :micronation-name="info.name.main" :icon="'googlemaps'"
